import {Position, MarkerType, Edge} from 'react-flow-renderer';
import {Test} from "./marker-symbols";
...
export function createNodesAndEdges() {
    ...
    nodes.push({ id: 'target', data: { label: 'Target' }, position: center, type: "classNode" });
